...
second_finetune_output_path = "./../model/TinyLlama-chatgpt-prompts-continue-finetune-navigation"
second_huggingface_repo_id = "st40404/TinyLlama-chatgpt-prompts-continue-finetune-navigation"
...
print("Loading new dataset: nav2_point.jsonl")
dataset = load_dataset("json", data_files="./../dataset/nav2_point.jsonl", split="train")
